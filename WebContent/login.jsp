		...
		<div class=" page-wrapper">
			<div class="masthead-wrapper">
				...
				<div class="masthead-right" role="navigation">
					<a href="register.jsp" id="login-link" class="btn btn--small btn--header btn--rounded login"> Register</a>
					<a href="login.jsp" id="login-link" class="btn btn--small btn--header btn--rounded login"> Login</a>
				...
				<div id="content1" class="clearit">
					<div class="fullWidth">
						<div id="loginForm">
							<form action="dologin.jsp?type=doLogin" method="post" name="myform" onSubmit="check()">
								...
								<table class="logintable">
									<tbody>
										...
										<tr>
											...
											<td align="left">
												<input type="password" id="password" name="uPass" value=""
													class="LoginBox" style="width: 98%;">
											</td>
											<td>
												&nbsp;
											</td>
							...
							<div id="signup" class="normal">
								<h2>
									<a
										href=""
										title="免费注册">Free registration</a>
								</h2>
