...
<%
	...
	mList=(List<PostModel>)mDao.getMList();
%>
...
html {
	...
	<body class="a-overview lang-zh theme-whittle" style="">
		<div class=" page-wrapper">
			...
			<strong>Post list</strong>		
			</h2> </td><td colspan="6" align="right">	<a href="add.jsp" class="anon-button">Publish Post</a><a href="userList.jsp" class="anon-button">User management</a></td></tr>
				<tr>
				...
				<tr>
					<td><%=lik.getTitle()%></td>
					<td width="50%"><%=lik.getIntorduction()%></td>
					<td><%=lik.getAddTime()%></td>
					<td>
					<a href="edit.jsp?&id=<%=lik.getId() %>">Edit</a>
					<a href="doEdit.jsp?&id=<%=lik.getId() %>&type=delPost">Delete</a>
					</td>
				</tr>
				<%
					}
